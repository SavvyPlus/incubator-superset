...
export type DuidSpotPremiumDatum = DataRecord;
...
export default function transformProps(chartProps: ChartProps) {
   ...
   * can also be accessed from your DuidSpotPremium.tsx file, but
  ...
  const data = queryData.data as DuidSpotPremiumDatum[];
