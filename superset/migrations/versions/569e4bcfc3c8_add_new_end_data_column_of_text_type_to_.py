...
# under the License.
"""Add new end_data column of text type to solarbi_slices table

Revision ID: 569e4bcfc3c8
Revises: ece17d37a350
Create Date: 2020-05-05 12:02:45.772180

"""

# revision identifiers, used by Alembic.
revision = '569e4bcfc3c8'
down_revision = 'ece17d37a350'
...
def upgrade():
    ...
    op.add_column('solarbi_slices', sa.Column('end_date', sa.String(length=200), nullable=True))
...
def downgrade():
    ...
    op.drop_column('solarbi_slices', 'end_date')
