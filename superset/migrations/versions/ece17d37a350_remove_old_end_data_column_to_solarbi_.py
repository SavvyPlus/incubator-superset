...
# under the License.
"""Remove old end_data column to solarbi_slices table

Revision ID: ece17d37a350
Revises: 4fadc5438005
Create Date: 2020-05-05 12:01:06.593187

"""

# revision identifiers, used by Alembic.
revision = 'ece17d37a350'
down_revision = '4fadc5438005'
...
def downgrade():
    ...
    op.add_column('solarbi_slices', sa.Column('end_date', mysql.DATETIME(), nullable=True))
